 ...
 -		
 -`browser {background-color: rgb(100, 100, 100) !important;}` – чтобы при открытии ссылки в новой вкладке экран был серым, а не белым, до момента, когда страница начнёт отображаться.		
 -		
 ...
 -Поддерживаемые на данный момент версии Firefox: **38.2.0 - 43**. <br>		
 ...
 -6. [Настройки](prefs/comfort_prefs.js) для комфорта. Ничего не ломают, делают удобным интернет-сёрфинг.		
 -		
 ...
 -		
 -## Твик реестра Microsoft Windows		
 -[Скачать](execute.reg)		
 -		
 -## Продвинутые аддоны		
